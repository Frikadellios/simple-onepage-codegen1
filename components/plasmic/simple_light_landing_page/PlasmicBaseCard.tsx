...
import sty from "./PlasmicBaseCard.module.css"; // plasmic-import: uYwAOg6hYj5IA1/css
...
function PlasmicBaseCard__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames(projectcss.all, sty.freeBox__wzOPn, {
          [sty.freeBoxlong__wzOPnWWoc0]: hasVariant($state, "long", "long")
        })}
      >
        {p.renderPlasmicSlot({
          defaultContents:
      ...
      {(hasVariant($state, "long", "long") ? true : true) ? (
        <div
          className={classNames(projectcss.all, sty.freeBox__la0BV, {
            [sty.freeBoxlong__la0BVwWoc0]: hasVariant($state, "long", "long")
          })}
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__n4ZLe)}
                role={"img"}
              />
            ),
