...
import sty from "./PlasmicFeatureCard.module.css"; // plasmic-import: jU9IwqvOEKEqE/css
  ...
  return (
    ...
    >
      {(hasVariant($state, "long", "long") ? true : true) ? (
        <div
          className={classNames(projectcss.all, sty.freeBox__pms0H, {
            [sty.freeBoxlong__pms0HFj0Oc]: hasVariant($state, "long", "long")
          })}
        >
          <div
            className={classNames(projectcss.all, sty.freeBox___4Z0JU, {
              [sty.freeBoxlong___4Z0JUFj0Oc]: hasVariant($state, "long", "long")
            })}
          >
            {p.renderPlasmicSlot({
              defaultContents: (
                <svg
                  className={classNames(projectcss.all, sty.svg___87HuN)}
                  role={"img"}
                />
              ),
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__qpfic, {
          [sty.freeBoxlong__qpficFj0Oc]: hasVariant($state, "long", "long")
        })}
      >
        {p.renderPlasmicSlot({
      ...
      {(hasVariant($state, "long", "long") ? true : true) ? (
        <div
          className={classNames(projectcss.all, sty.freeBox__spzm3, {
            [sty.freeBoxlong__spzm3Fj0Oc]: hasVariant($state, "long", "long")
          })}
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__gTkU8)}
                role={"img"}
              />
            ),
