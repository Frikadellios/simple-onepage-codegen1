...
import Plan from "../../Plan"; // plasmic-import: z7rDsi8qCdybAq/component
...
import Faq from "../../Faq"; // plasmic-import: 8U4hFbQ_LGnwtG/component
...
import sty from "./PlasmicPricing.module.css"; // plasmic-import: RB_f7nI0T51lrb/css
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          ...
          >
            ...
            >
              <div className={classNames(projectcss.all, sty.column__w4U4)}>
                <Plan
                  className={classNames("__wab_instance", sty.plan___7MMnO)}
                  price={
                    <div
                      className={classNames(
                        projectcss.all,
                ...
                >
                  <Button
                    className={classNames("__wab_instance", sty.button__eMwlH)}
              ...
              <div className={classNames(projectcss.all, sty.column___7Pk1Z)}>
                <Plan
                  className={classNames("__wab_instance", sty.plan__ilFu)}
                  description={
                    <p.Stack
                      as={"div"}
                      hasGap={true}
                      className={classNames(projectcss.all, sty.freeBox__c3Uh7)}
                    >
                      <Bullet
                        className={classNames(
                          "__wab_instance",
                ...
                >
                  <Button
                    className={classNames("__wab_instance", sty.button__ywLm0)}
                    color={"blue" as const}
                  >
                    {"Get started"}
                  </Button>
              ...
              <div className={classNames(projectcss.all, sty.column___8HAwj)}>
                <Plan
                  className={classNames("__wab_instance", sty.plan___5YcXx)}
                  name={"Enterprise"}
                  price={
                    <div
                      className={classNames(
                ...
                >
                  <Button
                    className={classNames("__wab_instance", sty.button__nbX21)}
                    color={"outlineBlue" as const}
                  >
                    {"Get started"}
                  </Button>
          ...
          >
            <p.Stack
              as={"div"}
              hasGap={true}
              className={classNames(projectcss.all, sty.freeBox__lg88Q)}
            >
              <Faq
                className={classNames("__wab_instance", sty.faq__dlVbU)}
                slot={
              ...
              <Faq
                className={classNames("__wab_instance", sty.faq__lW1M)}
                slot={
                  "Yes! You can. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur excepteur sint occaecat cupidatat."
                }
              >
              ...
              <Faq
                className={classNames("__wab_instance", sty.faq__paUQ)}
                slot={
                  "Yes! You can. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur excepteur sint occaecat cupidatat."
                }
              >
