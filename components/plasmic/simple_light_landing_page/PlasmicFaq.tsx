...
import sty from "./PlasmicFaq.module.css"; // plasmic-import: 8U4hFbQ_LGnwtG/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__dPc6M)}
      >
        <div className={classNames(projectcss.all, sty.freeBox___9MdxO)}>
          <div className={classNames(projectcss.all, sty.freeBox__syicg)}>
            {p.renderPlasmicSlot({
