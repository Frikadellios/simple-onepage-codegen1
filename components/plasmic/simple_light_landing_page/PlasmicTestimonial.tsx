...
import Avatar from "../../Avatar"; // plasmic-import: aBTuMx271PW0qO/component
...
import sty from "./PlasmicTestimonial.module.css"; // plasmic-import: bEzhQTeh2YcuEq/css

import QuoteDashesIcon from "./icons/PlasmicIcon__QuoteDashes"; // plasmic-import: B23O_-Ddkb4rQm/icon
  ...
  return (
    ...
    >
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__dC8Bt)}
      >
        <div
          className={classNames(
            projectcss.all,
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__prRFz)}
        >
          <div
            className={classNames(
              projectcss.all,
