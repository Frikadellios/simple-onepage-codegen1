...
import BaseCard from "../../BaseCard"; // plasmic-import: uYwAOg6hYj5IA1/component
...
import sty from "./PlasmicPlan.module.css"; // plasmic-import: z7rDsi8qCdybAq/css
...
function PlasmicPlan__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__lvT1H)}>
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__r1Rjq)}
        >
          {p.renderPlasmicSlot({
          ...
          {p.renderPlasmicSlot({
            defaultContents: (
              <p.Stack
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.freeBox__qCuOq)}
              >
                <Bullet
                  className={classNames("__wab_instance", sty.bullet__u1QeJ)}
                />

                <Bullet
                  className={classNames("__wab_instance", sty.bullet__fsoFb)}
                />

                <Bullet
                  className={classNames("__wab_instance", sty.bullet__jPcob)}
                />
              </p.Stack>
            ),
          ...
          <div className={classNames(projectcss.all, sty.freeBox__nlJmW)}>
            {p.renderPlasmicSlot({
              defaultContents: (
                <Button
                  className={classNames("__wab_instance", sty.button__bqpGc)}
