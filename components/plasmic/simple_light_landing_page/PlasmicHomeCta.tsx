...
import sty from "./PlasmicHomeCta.module.css"; // plasmic-import: AUubMfq8p8zkV/css
...
import SphereIcon from "./icons/PlasmicIcon__Sphere"; // plasmic-import: 4o8D-XO12bcpY1/icon
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__eDgVo)}
      >
        <div
          className={classNames(
            projectcss.all,
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__jCdRr)}
        >
          <TextInput
      ...
      {(hasVariant(globalVariants, "screen", "mobile") ? true : true) ? (
        <div className={classNames(projectcss.all, sty.freeBox___0YoD1)}>
          <SphereIcon
